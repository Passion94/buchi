...
function AfterNimbly() {
  return (
      ...
      <div className="after-nimbly">
        ...
        <h1><FontAwesomeIcon className=" fa-certificate fa-icon" icon={faCertificate} /><span id="education"> Education</span> </h1>
        <div className="bachelor">
        <h2> Bachelor's Degree | Accra Institute of Technology, Ghana</h2>

        <p className="micro"><FontAwesomeIcon className="fa-icon" icon={faCalendarAlt} /> 2013- 2016 </p>
        ...
        <div className="diploma">
          ...
          <p className="micro"> <FontAwesomeIcon className="fa-icon" icon={faCalendarAlt} /> 2010-2012 </p>
          <ul>
        ...
        <div className="machine-learning">
          ...
          <p className="micro">
          <FontAwesomeIcon className="fa-icon" icon={faCalendarAlt} /> 2016
          </p>
        ...
        <div className="system-security">
          ...
          <p className="micro fa-calender"> <FontAwesomeIcon className="fa-icon" icon={faCalendarAlt} /> 2015</p>
